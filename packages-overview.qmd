...
The `futurize()` function transpiles calls to sequential map-reduce functions such as `base::lapply()`, `purrr::map()`, and `foreach::foreach() %do% { ... }` into concurrent, parallel alternatives provided by **[future.apply]**, **[furrr]**, and **[doFuture]**.
