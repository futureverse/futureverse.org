...
description: The future framework with the future package at the code comprises many packages - use the ones that suit your needs
...
_BETA_: An future backend where you can share R compute among friends across the world.
