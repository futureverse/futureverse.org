...
continuous basis, correctness throughout.
...
reverse-package dependency checks using **revdepcheck**.  As of July
...
when an existing feature had to be removed, it has been done via a
