...
(GitHub Actions), and on R-hub. The core packages are also tested with
...
using **revdepcheck**.  As of December 2025,
the **future** package is tested against 510 direct reverse-package
...
existing R code in production that relies on futures.  In the very rare
