...
October 2023, **future** was among the top-0.8% most downloaded
package on CRAN (Figure 1) and there are 319 packages on CRAN that
directly depend on it (Figure 2).  For map-reduce parallelization
packages **future.apply** (top-0.9% most downloaded) and and **furrr**
(top 1.3%), the corresponding number of packages are 135 and 111,
...
via another package, then 85% of all ~20,000 CRAN packages may rely on
...
has 1,107 reverse package dependencies on CRAN.  The number of users
