...
May 2022, **future** was among the top-0.9% most downloaded package on
CRAN (Figure 1) and there are 225 packages on CRAN that directly
depend on it (Figure 2).  For map-reduce parallelization packages
**future.apply** (top-1.3% most downloaded) and and **furrr** (top
1.8%), the corresponding number of packages are 105 and 63,
...
via another package, then 83% of all ~18,500 CRAN packages may rely on
...
has 771 reverse package dependencies on CRAN.  The number of users
