...
among end-users and package developers has grown steadily.  During May
2026, **future** was among the top-0.6% most downloaded packages on
CRAN (Figure 1) and there are ~500 packages (+30%/year) on CRAN that
...
(+50%/year) and ~180 (+25%/year), respectively.  
...
~2,400 packages, show similar ratios.
