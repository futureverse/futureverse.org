...
April 2026, **future** was among the top-0.7% most downloaded packages
on CRAN (Figure 1) and there are 510 packages (+30%/year) on CRAN and
Bioconductor that directly depend on it (Figure 2).  For map-reduce
parallelization packages **future.apply** (top-0.7% most downloaded)
and **furrr** (top 1.2%), the corresponding number of packages are 290
(+50%/year) and 190 (+20%/year), respectively.  If we consider
