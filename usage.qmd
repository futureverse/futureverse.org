...
(+50%/year) and 200 (+25%/year), respectively.  If we consider
recursive dependencies too, that is, packages that use the **future**
package either directly or indirectly via another package, then 85% of
all ~24,000 CRAN packages may rely on the future framework for their
processing.
