...
More examples can be found on R-university, which lists [~1,600
...
(top 1.3%), the corresponding number of packages are ~300
(+55%/year) and ~180 (+25%/year), respectively.  

If we consider recursive dependencies too, that is, packages that
needs (depends or imports) the **future** package either directly or
...
for parallelization. Since the introduction of **futurize**, user can
