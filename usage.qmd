...
among end-users and package developers has grown steadily.  As of July
...
list it as a direct dependency (Figure 2).  For map-reduce
parallelization packages **future.apply** (top-0.8% most downloaded)
and **furrr** (top 1.3%), the corresponding number of packages is ~300
...
packages rely on the future framework for processing (July 2026).
