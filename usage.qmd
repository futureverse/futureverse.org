...
on CRAN (Figure 1) and there are 510 packages on CRAN and Bioconductor
...
(top 1.2%), the corresponding number of packages are 290 and 190,
...
has 1,350 reverse package dependencies on CRAN. The number of users
