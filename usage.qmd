...
May 2026, **future** was among the top-0.6% most downloaded packages
on CRAN (Figure 1) and there are 530 packages (+30%/year) on CRAN and
Bioconductor that directly depend on it (Figure 2).  For map-reduce
parallelization packages **future.apply** (top-0.8% most downloaded)
and **furrr** (top 1.3%), the corresponding number of packages are 310
(+50%/year) and 200 (+25%/year), respectively.  
...
indirectly via another package, then ~1,400 (5.1%) of all ~27,500 CRAN
and Bioconductor packages rely on the future framework for processing
(June 2026). If we include soft (Suggests) dependencies as well, then
~92% of all packages depend on the future framework.
...
## Number of packages: 27634 (CRAN+Bioconductor)
...
## Hard reverse dependencies: 1409 (5.1%) of 27634 (CRAN+Bioconductor)
...
## All (incl. Suggests) reverse dependencies: 25401 (91.9%) of 27634
-->
