...
Henrik has worked with R since 2000 and has contributed with many R packages on CRAN and Bioconductor.  With [30 CRAN packages](https://r-pkg.org/maint/henrikb@braju.com), he is among the top-10 maintainers there.  Several of his packages are among the top-1% most downloaded on CRAN.  He has also contributed with design and implementation to the R core distribution.

Cross-platform operability, long-term stability, correctness, and reproducibility are absolute top priorities throughout all his software projects.
