...
pathname <- ggsave(gg, filename = "downloads_over_time_on_CRAN.png", path = ".local", create.dir = TRUE, width = image_dims[1], height = image_dims[2])
message("Wrote: ", pathname)

gg <- gg + coord_cartesian(ylim = c(0.03, 0))
gg <- gg + theme(plot.margin = margin(t = 5, r = 20, b = -15, l = 5, unit = "pt"))
pathname <- ggsave(gg, filename = "downloads_over_time_on_CRAN-zoom.png", path = ".local", create.dir = TRUE, width = image_dims[1], height = image_dims[2])
message("Wrote: ", pathname)
...
gg <- gg + theme(plot.margin = margin(t = 5, r = 20, b = -15, l = 5, unit = "pt"))
pathname <- ggsave(gg, filename = "downloads_min_rank_over_time_on_CRAN.png", path = ".local", create.dir = TRUE, width = image_dims[1], height = image_dims[2])
message("Wrote: ", pathname)
