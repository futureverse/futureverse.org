...
**[doFuture]**, and any package that uses these, will run the code in
parallel.
...
| **[future.p2p]**[^3]<br> `p2p_cluster` | | ⚠️ prototype & proof of concept of a peer-to-peer cluster<br>Example: `plan(future.p2p::p2p_cluster, cluster = "alice/friends")` |
...
[^2]: for this combination, support for future cancellation will be
      added in a future release
[^3]: **future.p2p** is a prototype and a proof of concept for what is
      possible - it is not production ready
