...
[**Seurat**](https://satijalab.org/seurat/) is an R package designed for QC, analysis, and exploration of single-cell RNA-seq data. Seurat aims to enable users to identify and interpret sources of heterogeneity from single-cell transcriptomic measurements, and to integrate diverse types of single-cell data. [**Azimuth**](https://satijalab.org/azimuth/) is a Seurat-based web application, e.g. [HuBMAP - NIH Human Biomolecular Atlas Project](https://azimuth.hubmapconsortium.org/)
